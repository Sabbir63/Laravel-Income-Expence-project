			...
			<div class="card-header card_header">
				<div class="row">
					<div class="col-md-8 tbl_text">
						<i class=" uil-user-exclamation "></i>Tottal Income And Expense Summary
					</div>
						...
						<div class="col-md-6">
							<form method="get" action="{{url('dashboard/report/search')}}"  enctype="multipart/form-data" >
									<div class="input-group">
											<input type="date" id="s-from" name="start" class="form-control"  placeholder="" style="margin-right:5px;">
											<input type="date" id="s-to"name="end" class="form-control"  placeholder="">
				...
				<table id="reportsTableInfo" class="table table-bordered table-striped table-hover dt-responsive nowrap w-100">
					...
					<tbody>
						...
						<tr>
							<td></td>
							<td></td>
							<td style="text-align:right;">Tottal</td>
