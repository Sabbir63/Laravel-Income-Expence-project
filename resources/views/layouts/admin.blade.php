...
<head>
	...
	<link rel="stylesheet" rel="shortcut icon" href="{{asset('contents/admin')}}/assets/images/favicon.ico">
		...
		<div class="leftside-menu">
			...
			<div class="h-100" id="leftside-menu-container" data-simplebar>
				...
				<ul class="side-nav">
					...
					<li class="side-nav-item">
						<a data-bs-toggle="collapse" href="#sidebarIncome" aria-expanded="false" aria-controls="sidebarIncome" class="side-nav-link"><i class=" uil-bitcoin "></i><span> Income Category </span><span class="menu-arrow"></span></a>
						<div class="collapse" id="sidebarIncome">
							<ul class="side-nav-second-level">
								<li><a href="{{url('dashboard/income/category')}}">All Income CTG</a></li>
								<li><a href="{{url('dashboard/income/category/add')}}">Add Income CTG</a></li>
								<li><a href="{{url('dashboard/income/category')}}">Income Category CTG</a></li>
							</ul>
						</div>
					</li>

					<li class="side-nav-item">
						<a data-bs-toggle="collapse" href="#sidebarIIncome" aria-expanded="false" aria-controls="sidebarIIncome" class="side-nav-link"><i class=" uil-bitcoin "></i><span> Income  </span><span class="menu-arrow"></span></a>
						<div class="collapse" id="sidebarIIncome">
							<ul class="side-nav-second-level">
								...
								<li><a href="{{url('dashboard/incom')}}">Income Category</a></li>
							</ul>
						</div>
					</li>

					<li class="side-nav-item">
						<a data-bs-toggle="collapse" href="#sidebarExpense" aria-expanded="false" aria-controls="sidebarExpense" class="side-nav-link"><i class="  uil-exchange "></i><span> Expense Category</span><span class="menu-arrow"></span></a>
						<div class="collapse" id="sidebarExpense">
							<ul class="side-nav-second-level">
								<li><a href="{{url('dashboard/expense/category')}}">All Expense ETG</a></li>
								<li><a href="{{url('dashboard/expense/category/add')}}">Add Expense ETG</a></li>
								<li><a href="{{url('dashboard/expense/category')}}">Expense Catagory ETG</a></li>
							</ul>
						</div>
					</li>
					<li class="side-nav-item">
						<a data-bs-toggle="collapse" href="#sidebarIexpense" aria-expanded="false" aria-controls="sidebarIexpense" class="side-nav-link"><i class=" uil-bitcoin "></i><span> Expense  </span><span class="menu-arrow"></span></a>
						<div class="collapse" id="sidebarIexpense">
							<ul class="side-nav-second-level">
								<li><a href="{{url('dashboard/expense')}}">All Expense</a></li>
								<li><a href="{{url('dashboard/expense/add')}}">Add Expense</a></li>
								<li><a href="{{url('dashboard/expense')}}">Expense Category</a></li>
							</ul>
						</div>
					</li>
						<li class="side-nav-item"><a href="{{url('dashboard/recycle')}}" class="side-nav-link"><i class="uil-trash-alt"></i><span> Recycle Bin </span></a></li>
